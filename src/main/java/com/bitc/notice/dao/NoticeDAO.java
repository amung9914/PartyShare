...
public interface NoticeDAO {
	...
	@Update("UPDATE notice SET readed = 'Y' WHERE noticeNum = #{noticeNum} ")
	public void readPost(int noticeNum) throws Exception;	// noticeDAO
	...
	List<NoticeVO> myNotcie (String mId) throws Exception;	//noticeDAO
}
